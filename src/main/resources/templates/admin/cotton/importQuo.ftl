<html>
    ...
    <div id="FrameR">
        <form name="uploadExcelform" action="/cotton/importQuo" method="post" target="_self" enctype="multipart/form-data">
            <div style="padding:10px;">
                ...
                <p style="padding-left:68px;"> <a target="_blank" href="/file/quotation.xlsx" style="color:blue;">模板</a></p>
